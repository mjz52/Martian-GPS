...
if (i==1)
    q = [2*mx+1-tra;a(1,2)+a(2,1);a(1,3)+a(3,1);a(2,3)-a(3,2)];
elseif (i==2)
    q = [a(2,1)+a(1,2);2*mx+1-tra;a(2,3)+a(3,2);a(3,1)-a(1,3)];
elseif (i==3)
    q = [a(3,1)+a(1,3);a(3,2)+a(2,3);2*mx+1-tra;a(1,2)-a(2,1)];
else
    q = [a(2,3)-a(3,2);a(3,1)-a(1,3);a(1,2)-a(2,1);1+tra];      
end
